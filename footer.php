...
?>
	<footer id="colophon" class="site-footer bg-[var(--color-surface-container-low)] pt-16 pb-8 border-none mt-12">
		<div class="container">
			<div class="footer-content flex flex-col items-center gap-8">
                ...
                <!-- Social Links -->
				<div class="footer-socials flex gap-6 mt-4">
                ...
                <!-- Copyright & Info -->
				<div class="footer-info text-center font-body text-sm text-[var(--color-on-surface-muted)] border-t border-[var(--color-surface)] w-full pt-8">
					<p class="mb-1">&copy; <?php echo date( 'Y' ); ?> Santagatesi nel Mondo. Tutti i diritti riservati.</p>
					<p><small class="opacity-80">Associazione di Promozione Sociale - Via G. Garibaldi 44, 71028 Sant'Agata di Puglia (FG)</small></p>
				</div>
			</div>
		</div><!-- .container -->
	</footer><!-- #colophon -->
