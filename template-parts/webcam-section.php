...
<section id="webcam" class="section">
	<div class="container">
		<header class="section-header text-center mb-8">
			<h2 class="text-3xl font-bold mb-4">Webcam H24</h2>
			<p class="text-color-muted">Guarda Sant'Agata di Puglia in diretta streaming.</p>
		</header>
		...
		<div class="grid grid-cols-1 md:grid-cols-2 gap-8">
			...
			<div class="glass-panel text-center">
				<h3 class="text-xl mb-4">Vico V. Emanuele</h3>
			...
			<!-- Webcam 2 -->
			<div class="glass-panel text-center">
				<h3 class="text-xl mb-4">Piazza Toni Santagata</h3>
				<div class="webcam-container">
