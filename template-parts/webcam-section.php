...
// e aggiornabili dagli amministratori tramite il pannello di controllo admin blindato.
...
$webcam_1_visible = get_option( 'santagatesi_webcam_1_visible', '1' );
$webcam_2_visible = get_option( 'santagatesi_webcam_2_visible', '1' );

// Se entrambe le webcam sono state nascoste, non stampare l'intera sezione
if ( '0' === $webcam_1_visible && '0' === $webcam_2_visible ) {
    return;
}
?>
...
<section id="webcam" class="section">
	<div class="container mx-auto px-4 md:px-0">
		...
		<div class="grid grid-cols-1 <?php echo ( '1' === $webcam_1_visible && '1' === $webcam_2_visible ) ? 'lg:grid-cols-2' : ''; ?> gap-10">

            <?php if ( '1' === $webcam_1_visible ) : ?>
                <!-- Webcam 1 -->
                <div class="tonal-panel flex flex-col items-center bg-[var(--color-surface-container-lowest)] p-4 sm:p-6 rounded-2xl shadow-lg border border-[var(--color-surface-container-low)] relative w-full h-full <?php echo ( '0' === $webcam_2_visible ) ? 'max-w-4xl mx-auto' : ''; ?>">
            ...
            <?php if ( '1' === $webcam_2_visible ) : ?>
                <!-- Webcam 2 -->
                <div class="tonal-panel flex flex-col items-center bg-[var(--color-surface-container-lowest)] p-4 sm:p-6 rounded-2xl shadow-lg border border-[var(--color-surface-container-low)] relative w-full h-full <?php echo ( '0' === $webcam_1_visible ) ? 'max-w-4xl mx-auto' : ''; ?>">
